        ...
        if (table === tables.formularios) {
            ...
            if (method === 'ID') {
                ...
                try {
                    ...
                    result = error;
                    console.log('erro ao selecionar (serviceForms) ' +  error);
                }
            }
        }
    }
    ...
    if(action == 'INSERT'){
        ...
        if(table == tables.formularios){
            try { 
                ...
                console.log('erro ao inserir (serviceForms) ' +  error);
            }
        }
    }
    ...
    if(action == 'UPDATE'){
        if(table == tables.formularios){
            try {
                ...
                console.log('erro ao atualizar (serviceForms) ' +  error);
            }
        }
    }
    ...
    if(action == 'DELETE'){
        if(table == tables.formularios){
            try {
                ...
                console.log('erro ao deletar (serviceForms) ' +  error);
            }
        }
    }    
    return result;
